const MQTT_CONFIG = {
  ...
  port: 9001, // Tetap gunakan port WebSocket
  user: "nexaryn",
  pass: "31750321",
...
function connectMQTT() {
  client.connect({
    ...
    onSuccess: () => {
      console.log("Connected to Sensor Feed");
      updateNavStatus(true);
      client.subscribe("MIAUW/sensor/distance"); // Subscribe ke data sensor
    },
    onFailure: (err) => {
      console.log("Failed: " + err.errorMessage);
